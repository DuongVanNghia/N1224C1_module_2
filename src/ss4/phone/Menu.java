...
public class Menu {
    ...
    static {
        phones.add(new OldPhone("Dien thoai 1 cu", 5000000, 6, "Xiaomi", 90, "Nguyen zin"));
        phones.add(new OldPhone("Dien thoai 2 cu", 5500000, 6, "Apple", 95, "Nguyen zin"));

        phones.add(new NewPhone("Dien thoai 3 moi", 10000000, 12, "SamSung", 10));
        phones.add(new NewPhone("Dien thoai 4 moi", 12000000, 12, "Oppo", 30));
    }
            ...
            try {
                ...
                switch (choice) {
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        System.out.println("Tổng giá tiền của tất cả điện thoại trong cửa hàng: " + calculateTotalPricePhone() + " $");
                        break;
                    case 8:
                        System.out.print("Nhập vào % muốn giảm giá: ");
                        double percentDiscount = Double.parseDouble(sc.nextLine());
                        applyDiscount(percentDiscount);
    ...
    private static double calculateTotalPricePhone() {
